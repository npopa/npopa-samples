...
package com.sa.npopa.samples.hbase.rest.client;
...
import com.sa.npopa.samples.hbase.rest.client.Client1;
import com.sa.npopa.samples.hbase.rest.client.Cluster;
import com.sa.npopa.samples.hbase.rest.client.Response;
...
public class Client1 {
  ...
  private static final Log LOG = LogFactory.getLog(Client1.class);
   ...
   */
  public Client1(Cluster cluster) {
   ...
   */
  public Client1(Cluster cluster, boolean sslEnabled) {
