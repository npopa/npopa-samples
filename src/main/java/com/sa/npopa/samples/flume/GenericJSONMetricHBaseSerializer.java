...
public class GenericJSONMetricHBaseSerializer extends GenericJSONHBaseSerializer {


	private static final Logger LOGGER = LoggerFactory.getLogger(GenericJSONMetricHBaseSerializer.class);
	...
	public GenericJSONMetricHBaseSerializer() {
